...
const INITIAL_PLAYERS = {
    ...
    cow: {
        name: '神秘牛',
        money: 10000, // 增加初始资金到10000
        shares: 100000, // 神秘牛持有10万份
        icon: '🐮',
        emotion: 'neutral',
        initialMoney: 10000,
...
export const useGameState = () => {
    ...
    const [animalStatus, setAnimalStatus] = useState({}); // 动物状态：active/working/hibernating/left
    ...
    const calculateCompanyShares = useCallback((currentPlayers) => {
        ...
        console.log(`🏛️ 计算公司股份: 总股份${TOTAL_SHARES} - 玩家持有${totalPlayerShares} = 公司持有${companyShares}`);
